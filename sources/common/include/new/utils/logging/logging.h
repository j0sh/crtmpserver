...
#include "new/utils/logging/consoleloglocation.h"
#include "new/utils/logging/fileloglocation.h"
#include "new/utils/logging/logcatloglocation.h"
#include "new/utils/logging/logger.h"
