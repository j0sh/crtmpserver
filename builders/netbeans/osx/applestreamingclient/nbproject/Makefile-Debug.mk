...
${OBJECTDIR}/_ext/53446657/finetimer.o: ../../../../sources/applications/applestreamingclient/src/protocols/timer/finetimer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/53446657
	${RM} $@.d
	$(COMPILE.cc) -g -DOSX -DNET_KQUEUE -DLITTLE_ENDIAN_BYTE_ALIGNED -DHAS_PROTOCOL_RTMP -DHAS_PROTOCOL_HTTP -DHAS_PROTOCOL_TS -DHAS_PROTOCOL_VAR -DHAS_MS_TIMER -I/opt/local/include -I../../../../sources/common/include -I../../../../sources/thelib/include -I../../../../sources/applications/applestreamingclient/include -I../../../../../android/workbench/android-ndk-r4-crystax/build/platforms/android-4/arch-arm/usr/include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/53446657/finetimer.o ../../../../sources/applications/applestreamingclient/src/protocols/timer/finetimer.cpp
