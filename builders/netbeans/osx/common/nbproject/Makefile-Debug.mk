...
${OBJECTDIR}/_ext/207925497/logcatloglocation.o: ../../../../sources/common/src/logging/logcatloglocation.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -DOSX -DUSE_MEM_POOL -DDEBUG_MEM_POOL -DLITTLE_ENDIAN_SHORT_ALIGNED -I/opt/local/include -I../../../../sources/common/include -I/opt/local/include/libxml2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/207925497/logcatloglocation.o ../../../../sources/common/src/logging/logcatloglocation.cpp
