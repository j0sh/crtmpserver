...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/libappselector.so

dist/Release/GNU-Linux-x86/libappselector.so: ${OBJECTFILES}
...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/_DOTDOT/sources/applications/appselector/src/appselector.o: nbproject/Makefile-${CND_CONF}.mk ../../../../sources/applications/appselector/src/appselector.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/_DOTDOT/sources/applications/appselector/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -DOSX -DNET_EPOLL -I../../../../sources/common/include -I../../../../sources/thelib/include -I../../../../sources/applications/appselector/include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/_DOTDOT/_DOTDOT/sources/applications/appselector/src/appselector.o ../../../../sources/applications/appselector/src/appselector.cpp
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/libappselector.so
