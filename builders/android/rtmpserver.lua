...
configuration=
{
	...
	applications=
	{
		...
		--this is where the applications array starts
		{
			...
			library="/data/output/dynamic/applications/appselector/libappselector.so",
		...
		},
		{
			...
			name="flvplayback",
			protocol="dynamiclinklibrary",
			library="/data/output/dynamic/applications/flvplayback/libflvplayback.so",
			aliases=
			{
				"simpleLive",
				"vod",
		...
		},
		{
			...
			protocol="dynamiclinklibrary",
			library="/data/output/dynamic/applications/proxypublish/libproxypublish.so",
			acceptors =
			{
				{	
					ip="0.0.0.0",
		...
		},
		{
            ...
            protocol="dynamiclinklibrary",
			library="/data/output/dynamic/applications/applestreamingclient/libapplestreamingclient.so",
            aliases=
            {
                "asc",
            },
